...
license_head_verl_25 = "Copyright (c) 2025 verl-project authors."
license_head_verl_26 = "Copyright (c) 2026 verl-project authors."
license_headers = [
    ...
    license_head_huawei,
    license_head_verl_25,
    license_head_verl_26,
]
