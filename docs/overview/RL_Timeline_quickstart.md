...
模块划分、流水线与扩展步骤见 [架构与开发指导](https://github.com/verl-project/rl-insight/blob/v0.1.x/docs/overview/architecture.md)。更完整的数据目录与 JSON 字段约定见 [数据规格与格式说明](https://github.com/verl-project/rl-insight/blob/v0.1.x/docs/data/data_specification.md)。
...
依赖版本以仓库根目录 [`requirements.txt`](https://github.com/verl-project/rl-insight/blob/v0.1.x/requirements.txt) 为准（含 **pandas、plotly、numpy、loguru** 等）。开发/运行前请安装：
...
4. MSTX 数据满足以下要求：
   ...
   - 离线解析参考 [MSTX profiling 离线解析](https://github.com/verl-project/rl-insight/blob/v0.1.x/docs/utils/mstx_preprocessing.md)
...
目录与 JSON 字段的集中说明另见 [数据规格与格式说明](https://github.com/verl-project/rl-insight/blob/v0.1.x/docs/data/data_specification.md)。运行时校验逻辑以 `rl_insight.data.DataChecker` 及 [`rl_insight/data/rules.py`](https://github.com/verl-project/rl-insight/blob/v0.1.x/rl_insight/data/rules.py) 中的规则定义为准。
